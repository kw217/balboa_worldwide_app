...
* [protocol.md](doc/protocol.md) - documents what is definitely known of the protocol.
* The [wiki](https://github.com/ccutrer/balboa_worldwide_app/wiki) - working area for decoding the protocol. 
